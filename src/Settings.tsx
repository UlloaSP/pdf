    ...
    >
      ...
      >
        ...
        <div
          ...
          key={section}
        >
          <TabsContent value={section} className="mx-auto flex max-w-3xl flex-col gap-7 pt-3">
            ...
            {section === "general" && (
              <>
                ...
                <Group title="Actualizaciones">
                  ...
                  <Row title="Frecuencia de comprobación" disabled={!settings.autoCheckUpdates}>
                    <NativeSelect
            ...
            {section === "shortcuts" && (
              <>
                <Alert>
                  ...
                  <AlertDescription>
                    Pulsa su combinación actual y después las nuevas teclas. Incluye Ctrl o Alt.
              ...
              <>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Herramientas para tus documentos e imágenes.</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <FieldGroup>

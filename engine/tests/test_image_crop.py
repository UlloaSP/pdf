...
from engine.features import image_crop as feature
...
class ImageTests(unittest.TestCase):
    def setUp(self):
        ...
        self.options = {'x': 5, 'y': 5, 'width': 20, 'height': 15}
    ...
    def test_rejects_svg_and_bad_option(self):
        ...
        with self.assertRaises(ValueError): feature.run([str(self.source)],str(self.out),{'width': 900})

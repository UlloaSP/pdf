...
Recorta un rectángulo en píxeles desde la esquina superior izquierda. Normaliza la orientación EXIF y aplica el mismo recorte a todos los fotogramas GIF.
